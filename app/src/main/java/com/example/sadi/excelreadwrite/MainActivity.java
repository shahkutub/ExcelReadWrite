...
public class MainActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState)
    {
        ...
        context = this;
        writeExcelButton = (Button) findViewById(R.id.writeExcelButton);
        readExcelButton = (Button) findViewById(R.id.readExcelButton);

        writeExcelButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                saveExcelFile(context,"myExcel.xls");
        ...
        readExcelButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                readExcelFile(context,"myExcel.xls");
